...
if isfield(SPM.xVi,'Vi')
    ...
    if length(unique(len))>1  % This is a group comparison with sizes of the group different
        ...
        if unique(len)==size(SPM.xVi.Vi{1},1)/2 % This is a group comparison with same size of the groups
