function hmri_local_defaults_BSS7T_repro
% PURPOSE
...
hmri_def.coreg2PDw = 0; % because everything is coregistered beforehand
...
hmri_def.imperfectSpoilCorr.BSS_Repro_7T.P2_a = [129.3280, -165.4986,   60.1435];
hmri_def.imperfectSpoilCorr.BSS_Repro_7T.P2_b = [-0.1861,    0.1913,    0.9383];
