function hmri_local_defaults_BSS_repro
% PURPOSE
...
hmri_def.MPMacq_set.names{8} = 'BSS_Repro';
hmri_def.MPMacq_set.tags{8}  = 'BSS_Repro';
hmri_def.MPMacq_set.vals{8}  = [24 24 6 21];

% 8) 500um protocol - seq version 7T from Leipzig for 500um:
hmri_def.imperfectSpoilCorr.BSS_Repro.tag = 'BSS_Repro';
hmri_def.imperfectSpoilCorr.BSS_Repro.P2_a = [64.208646466533651, -85.897879524215227,  40.486288752195307];
hmri_def.imperfectSpoilCorr.BSS_Repro.P2_b = [-0.124060143406205,   0.123661717926110,   0.956103928148643];
hmri_def.imperfectSpoilCorr.BSS_Repro.enabled = hmri_def.imperfectSpoilCorr.enabled;
